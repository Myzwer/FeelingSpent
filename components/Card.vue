			...
			<div class="grid grid-cols-12 gap-4">
				<div class=" col-span-12 md:col-span-6 bg-white rounded-xl shadow-xl card-lock relative">
					<div class="card-1-background rounded-t-xl relative">
						<div class="absolute bottom-5 left-5">
							<h2 class="font-bold text-white capitalize text-xl">Financial Peace University</h2>
						</div>
					</div>
					<div class="p-5">
						<h3>February 18-20</h3>
						<h2 class="font-bold">Foothills Church Maryville Location</h2>
						<p class="pt-5">Join us for Dave Ramsay’s FPU, where you can learn to take control of your
							money and take back your life.</p>
					</div>
				...
				<div class=" col-span-12 md:col-span-6 bg-white rounded-xl shadow-xl card-lock relative">
					<div class="card-2-background rounded-t-xl relative">
						<div class="absolute bottom-5 left-5">
							<h2 class="font-bold text-white capitalize text-xl">Everydollar Budgeting Software</h2>
						</div>
					</div>
					<div class="p-5">
						<h3>Free to Use</h3>
						<h2 class="font-bold">Convenient, easy to use budgeting software</h2>
						<p class="pt-5">Want to get on a budget in 2023? Well we have made EveryDollar available to all partners!</p>
					</div>
...
.card-2-background {
	background: linear-gradient(
		rgba(0, 0, 0, 50%),
		rgba(0, 0, 0, 50%)
	), url("~static/images/everydollar.jpg");
	background-position: center center;
	background-repeat: no-repeat;
	background-size: cover;
	height: 200px;
